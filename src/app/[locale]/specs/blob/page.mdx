...
An example raw blob CID, in base32 string encoding: [`bafkreibjfgx2gprinfvicegelk5kosd6y2frmqpqzwqkg7usac74l3t2v4`](https://cid.ipfs.tech/#bafkreibjfgx2gprinfvicegelk5kosd6y2frmqpqzwqkg7usac74l3t2v4)
